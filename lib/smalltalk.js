...
(function (global) {
    ...
    function SmallTalk(callback) {
        ...
        this.alert = function (title, msg, options) {
            return showDialog(title, msg, '', options.buttonOk ? options.buttonOk : BUTTON_OK, options);
        };
        ...
        this.prompt = function (title, msg, value, options) {
            ...
            return showDialog(title, msg, valueStr, options.buttonOkCancel ? options.buttonOkCancel : BUTTON_OK_CANCEL, options);
        };

        this.confirm = function (title, msg, options) {
            return showDialog(title, msg, '', options.buttonOkCancel ? options.buttonOkCancel : BUTTON_OK_CANCEL, options);
        };
